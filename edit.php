    ...
    <div class="container-fluid">
       ...
       <li class="nav navbar-right"><a href="logout.php" id="log">Logout</a></li>
        ...
        <div class="row">
           ...
           <div class="col-sm-5 col-sm-offset-3" id="form" style="margin-top:50px">
         <?php 
             foreach(@$edit as $u)
            {
    ?>
               ...
               <div class="form-group " style="display:none;">
                 ...
                 <div class="form-group ">
                    <label for="" class="control-label ">Rate:</label>
                     <input type="text" class=" form-control " name="rt" value="<?php echo $u->rate; ?>" required >
                 ...
                 <div class="form-group">
                     <input type="submit" class="btn btn-default" name="update_data" Value="Update!" >
                 </div>
